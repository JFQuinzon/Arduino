...
void loop() {
  ...
  else if (bt_ir_data == 10 || bt_ir_data == 'q') {
    mode = 2;
    Speed = 255;
  ...
  if (mode == 0) {
    ...
    //                          Key Control Command
    //===============================================================================
    if (bt_ir_data == 1 || bt_ir_data == 'F') { forword(); }  // if the bt_data is '1' the DC motor will go forward
    else if (bt_ir_data == 2 || bt_ir_data == 'B') {
      backword();
    }                                          // if the bt_data is '2' the motor will Reverse
    else if (bt_ir_data == 3 || bt_ir_data == 'L') { turnLeft(); }  // if the bt_data is '3' the motor will turn left
    else if (bt_ir_data == 4 || bt_ir_data == 'R') {
      turnRight();
    }                                      // if the bt_data is '4' the motor will turn right
    else if (bt_ir_data == 5 || bt_ir_data == 'S') { Stop(); }  // if the bt_data '5' the motor will Stop
